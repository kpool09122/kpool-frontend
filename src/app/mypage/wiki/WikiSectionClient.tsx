...
export const defaultMyPageDraftImageAdapter: MyPageDraftImageAdapter = {
...
export const defaultMyPageDraftWikiAdapter: MyPageDraftWikiAdapter = {
...
export function WikiSectionClient({
  children,
  draftImageAdapter = defaultMyPageDraftImageAdapter,
  draftWikiAdapter = defaultMyPageDraftWikiAdapter,
