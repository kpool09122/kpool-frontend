...
import type { AdminIdentitySettingsState } from "../adminTypes";
import {
...
export const useUserSettings = ({
  ...
  const [settingsState, setSettingsState] = useState<AdminIdentitySettingsState>(() =>
