...
import type { AdminDraftWikiActionTab, AdminWikiListItem } from "../useAdminDraftWikis";
...
type RejectDraftWikiDialogProps = { isOpen: boolean; isSubmitting: boolean; t: ReturnType<typeof useI18n>["dictionary"]["admin"]; onClose: () => void; onSubmit: (reason: string) => void };
...
type DraftWikiRejectReasonDialogProps = { reason: string | null; t: ReturnType<typeof useI18n>["dictionary"]["admin"]; onClose: () => void };
...
export const getDraftWikiRejectionReason = (wiki: AdminWikiListItem): string | null => {
  const reason = "rejectionReason" in wiki ? wiki.rejectionReason : null;

  return typeof reason === "string" && reason.trim() ? reason : null;
};

const isDraftWikiListItem = (wiki: AdminWikiListItem): wiki is WikiDraftWiki =>
...
export const getDraftWikiListCardHref = (wiki: AdminWikiListItem, tab: AdminDraftWikiActionTab): string =>
...
export const buildDraftWikiListCardStyle = (wiki: AdminWikiListItem): CSSProperties | undefined => {
