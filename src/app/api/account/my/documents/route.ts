...
import { getAccountApiBaseUrl, parseListAccountDocumentsResponse } from "@/gateways/account/accountApi";
import {
...
export async function GET(request: NextRequest) {
  ...
  try {
    const apiResponse = await fetch(`${baseUrl}/my/documents`, {
      method: "GET",
    ...
    return NextResponse.json(parseListAccountDocumentsResponse(body), { status: apiResponse.status });
  } catch (error) {
