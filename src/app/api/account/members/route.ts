...
import { getAccountApiBaseUrl, parseAccountMembersResponse } from "@/gateways/account/accountApi";
import {
...
export async function GET(request: NextRequest) {
  ...
  try {
    const apiResponse = await fetch(`${baseUrl}/members`, {
      method: "GET",
    ...
    return NextResponse.json(parseAccountMembersResponse(body), { status: apiResponse.status });
  } catch (error) {
